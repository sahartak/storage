...
SmartInfoWindow.prototype.draw = function() {
  ...
  switch (alignment) {
    ...
    case SmartInfoWindow.Align.LEFT:
      ...
      if(alignmentAll[0]['key']=='above' || alignmentAll[1]['key']=='above')
      {
        this.offsetY_ = -(this.height_ / 2 + 22)-20;  
      }
      else if(alignmentAll[0]['key']=='bottom' || alignmentAll[1]['key']=='bottom')
      {
       this.offsetY_ = -(this.height_ / 2 + 22)+60;   
      }
      else
      {
  ...
  this.div_.style.left = (pixPosition.x + this.offsetX_) + centerOffsetX + 5 + 'px';
