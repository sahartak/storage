	...
	<div class="col-md-12">
		...
		<div class="portlet light bordered">
			<div class="portlet-body form">
				<h2><?=$this->lang->line('receive_package_from_customer')?></h2>
					...
					<div class="form-body">
						...
						<div class="form-group">
							...
							<div class="col-md-9">
								...
								<button type="button" class="btn btn-primary" id="best_submit">Submit</button>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-md-9">
								...
								<button type="button" class="btn btn-primary" id="good_submit">Submit</button>
							</div>
						</div>
