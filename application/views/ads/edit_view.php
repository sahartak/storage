            ...
            <div class="portlet-body">
                ...
                <div class="form-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <img src="<?=base_url('upload/ads/'.$ad['image'])?>" height="100">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <select name="size" class="form-control">
                                <?php foreach($sizes as $key => $size):?>
                                    <option value="<?=$key?>" <?php if($key == $ad['size']) echo 'selected'?>><?=$size['width'],'x',$size['height']?></option>
                                <?php endforeach?>
                            </select>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <input type="url" name="url" required="" value="<?=$ad['url']?>"  class="form-control" />
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <select name="visible" class="form-control">
                                ...
                                <option value="0" <?php if(!$ad['visible']) echo 'selected' ?>><?=$this->lang->line('not_visible')?></option>
                            </select>
                        </div>
                    </div>
