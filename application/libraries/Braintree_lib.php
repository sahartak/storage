...
class Braintree_lib
{
	private $last_errors;			// array of last errors encountered
	private $CI;							// PAPA
	...
	public function add_sale($order_id, $amount, $nonce)
	{
